...
**Controller** - Контроллер вызывает методы представления исходя из того какой экран
...
Обрати внимание на очень важный момент. После того как View считывает пользовательский
