...
2. **Установка зависимостей Sequelize и PostgreSQL** и **Установка Sequelize CLI**

   Установите основные зависимости, а для работы с миграциями и моделями установите Sequelize CLI как dev-зависимость

   ```bash
   npm install sequelize pg pg-hstore && npm i -D sequelize-cli
   ```

3. **Настройка `.sequelizerc`**
...
4. **Инициализация структуры проекта для Sequelize**
...
7. **Отключение логов SQL-запросов**  
